...
INSERT INTO nguoi_dung VALUES
	('hoang0207', '$2a$08$Kn.YyLUJ27frbe14g64e9Oac.bM0PZPNgFPQn1jdpYSy.twLfUmJ2', N'Nguyễn Văn Kim Hoàng', 1, '2003-07-02', '0849314345', N'293 Nam Kỳ Khởi Nghĩa, TP.HCM', 'steve02072003@gmail.com', null, '2024-10-3', 1,null),
	('hoa232', '$2a$12$uPseTedEKRVLrHn4m76r0uRtF3BDG.GKxkNO0OSvp6Aj0e54K/QUW', N'Lưu Đức Hòa', 1, '2003-01-03', '0979324347', N'85 Phan Kế Bính, Đa Kao, Quận 1, Hồ Chí Minh', 'hoa2222@gmail.com', null, '2024-10-3', 1,null),
	('thanh222', '$2a$12$SNhzplR2ag6NPey3xzq2GuHXpQlfApCDCcG9hQxL/t3t46Hq.33V.', N'Nguyễn Văn Thanh', 1, '2003-11-30', '0849314345', N'142 Nguyễn Văn Công, Phường 3, Gò Vấp, Hồ Chí Minh', 'thanh23232@gmail.com', null, '2024-10-3', 1,null),
	('long888', '$2a$12$P19w4f9eUA1jV4Q.Yp65uOnH4WD.lPXTHEBiva8WhqmczHWm6beQG', N'Trần Chiến Long', 1, '2003-03-02', '0908730881', N'345 Tô Ký, Trung Mỹ Tây, Quận 12, Hồ Chí Minh', 'long888@gmail.com', null, '2024-10-3', 1,null),
	('linh775', '$2a$12$4VG79QKr/7AhkLHJMlR2be1TUgTPjSlKoLl1idg9wIemwDx3KD9UC', N'Nguyễn Kiều Thảo Linh', 0, '2003-05-06', '0909748663', N'194 Hoàng Văn Thụ, Phường 9, Phú Nhuận, Hồ Chí Minh', 'Linh775@gmail.com', null, '2024-10-3', 1,null),
	('Thang443', '$2a$12$k8el23GxOF2cy8MCI7sS2uM5CxNTFJKb59ZcNko1/O0KNIF6Q6SQC', N'Trần Ngọc Thắng', 1, '2003-04-23', '0907574883', N'141 Lê Thị Nho, Trung Mỹ Tây, Quận 12, Hồ Chí Minh', 'Thang443@gmail.com', null, '2024-10-3', 1,null),
    ('user001', '$2a$12$SXhEbPg9fSD76rJ5UkLap.bmLcLMZs5EmA2QYEa584nAFgKJiz3Sy', N'Nguyễn Anh Dũng', 1, '2000-08-10', '0908000001', N'10 Lý Thái Tổ, Quận 10, TP.HCM', 'user001@gmail.com', null, '2024-07-01', 1,null),
    ('user002', '$2a$12$vs9aDy2TZO6Wb9tpFAeuFu.o1tNSOxLTzrEYW/IP00Bq6kjbvm0HO', N'Hoàng Thị Ngọc', 0, '2000-09-05', '0908000002', N'12 Phan Đình Phùng, Quận 1, TP.HCM', 'user002@gmail.com', null, '2024-07-01', 1,null),
    ('user003', '$2a$12$PGZesjE3JRfU2NECuWos8./t2uFXjxQ0cVsioRvzidHZCHjf4VsTW', N'Phạm Minh Hòa', 1, '1999-12-15', '0908000003', N'23 Võ Thị Sáu, Bình Thạnh, TP.HCM', 'user003@gmail.com', null, '2024-07-01', 1,null),
    ('user004', '$2a$12$s0LBLc.CAXkvv2hQ3jNnOOrZnOW5t34lp8FrePpBuG4fFvelNNEAS', N'Lê Thị Hồng', 0, '2001-02-20', '0908000004', N'15 Trường Chinh, Tân Bình, TP.HCM', 'user004@gmail.com', null, '2024-07-01', 1,null),
    ('user005', '$2a$12$eFxQJFYKchun61KnLhvI0eQ.cU7kRbnpKSjvep/E3hOUBQTc5RE4a', N'Võ Đình Nam', 1, '2002-05-22', '0908000005', N'9 Tân Sơn Nhì, Tân Phú, TP.HCM', 'user005@gmail.com', null, '2024-07-01', 1,null),
    ('user006', '$2a$12$GIMUzp0NRswyJZDd1y2WOOCp0uR4BjHgS.dzXxL/smtGLzqTubcE.', N'Nguyễn Thanh Trúc', 0, '2001-03-10', '0908000006', N'18 Phan Văn Trị, Gò Vấp, TP.HCM', 'user006@gmail.com', null, '2024-08-01', 1,null),
    ('user007', '$2a$12$g/T3CIILF9eMWjnF8LltL.fLF3Xa714qdrasWNcrnxWSOeAbboxVO', N'Trần Hữu Phúc', 1, '2003-07-02', '0908000007', N'20 Nguyễn Trãi, Quận 5, TP.HCM', 'user007@gmail.com', null, '2024-08-01', 1,null),
    ('user008', '$2a$12$mUCQyNl2UeBRfed8c7brk.r.evCUHzcwYVDjOox7QjFrbdXZ0bIDq', N'Lê Mai Lan', 0, '1998-11-18', '0908000008', N'27 Nguyễn Thị Minh Khai, Quận 3, TP.HCM', 'user008@gmail.com', null, '2024-08-01', 1,null),
    ('user009', '$2a$12$ElQGZEg2I8xQaJ3IlFcTYedgF8ToWdCc3AQ12fIJfDQCo0Dw6RqR6', N'Phạm Văn Hiếu', 1, '2001-10-30', '0908000009', N'7 Lê Quang Định, Bình Thạnh, TP.HCM', 'user009@gmail.com', null, '2024-08-01', 1,null),
    ('user010', '$2a$12$06KxdBT77RqFw.iquT1YhO7JWnqzdh8uJfmkvXJhUGPowp455rDnO', N'Trần Thị Mai', 0, '2000-06-25', '0908000010', N'5 Cách Mạng Tháng 8, Quận 3, TP.HCM', 'user010@gmail.com', null, '2024-08-01', 1,null),
    ('user011', '$2a$12$zynCqAOxobWWOS.e5/Ss4OiaGbVKCY4WbDjaVUjdqxOIXTyfYk4T.', N'Trịnh Văn Lâm', 1, '2002-04-12', '0908000011', N'1 Đinh Tiên Hoàng, Bình Thạnh, TP.HCM', 'user011@gmail.com', null, '2024-09-01', 1,null),
    ('user012', '$2a$12$mIcGq.Uh6xWOQ17SUNcVQOoqUIzsm2A6Ve2BDn5dafsH1HEUI1SKa', N'Vũ Thị Thanh', 0, '1997-07-17', '0908000012', N'3 Hai Bà Trưng, Quận 1, TP.HCM', 'user012@gmail.com', null, '2024-09-01', 1,null),
    ('user013', '$2a$12$OfBaL7e/NhJ6R98LOSi3a.IQb03FmNkZbbbmrdO/2gg88jiyRJAEC', N'Nguyễn Tấn Phát', 1, '1999-10-08', '0908000013', N'4 Lê Văn Sỹ, Quận Phú Nhuận, TP.HCM', 'user013@gmail.com', null, '2024-09-01', 1,null),
    ('user014', '$2a$12$j0IUP.ugxe52ZokOkLbUG.tCJnegOqls9WwG4CQ.g.X8mhJ8/qkD2', N'Phạm Thanh Sơn', 1, '2001-01-15', '0908000014', N'17 Võ Văn Tần, Quận 3, TP.HCM', 'user014@gmail.com', null, '2024-09-01', 1,null),
    ('user015', '$2a$12$hAY83wYDkOhv341RmHmosOHajnoJ.NnO4xkg5cGs/TGfdbCnyktwe', N'Lê Quang Dũng', 1, '1998-08-18', '0908000015', N'8 Trần Hưng Đạo, Quận 5, TP.HCM', 'user015@gmail.com', null, '2024-09-01', 1,null),
    ('user016', '$2a$12$l5cPNxLN1kXSRo/jLxrPKu.Cvanc/NbIKiud1y6r.kg3wUeSEddc2', N'Đặng Thị Hòa', 0, '1996-12-23', '0908000016', N'6 Nguyễn Văn Cừ, Quận 5, TP.HCM', 'user016@gmail.com', null, '2024-10-01', 1,null),
    ('user017', '$2a$12$g3PDNFVxDzygq/gKVjHakus7PbOkPlswbbSMatub18sSRlAogGMMO', N'Thái Thanh Bình', 1, '1997-09-11', '0908000017', N'14 Nguyễn Huệ, Quận 1, TP.HCM', 'user017@gmail.com', null, '2024-10-01', 1,null),
    ('user018', '$2a$12$3BgJetah3pTsGDyfTfaKy.I83slzhwW2/oly5y/3GTJ.iLiHjnl5i', N'Lê Phương Dung', 0, '2002-03-25', '0908000018', N'25 Trần Não, Quận 2, TP.HCM', 'user018@gmail.com', null, '2024-10-01', 1,null)
